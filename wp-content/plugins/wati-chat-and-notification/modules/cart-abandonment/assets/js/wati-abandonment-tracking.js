(function ($) {
  ...
  var wcf_cart_abandonment = {
    ...
    _set_cookie: function () {
      ...
      jQuery.post(CartFlowsProCAVars.ajaxurl, data, function (response) {
        if (response.success) {
    ...
    _getCheckoutData: function () {
      ...
      if (
        ...
        var data = {
          ...
          csrf_token: CartFlowsProCAVars._nonce,
          wcf_post_id: CartFlowsProCAVars._post_id,
          wcf_product_image: wcf_product_image,
        };
