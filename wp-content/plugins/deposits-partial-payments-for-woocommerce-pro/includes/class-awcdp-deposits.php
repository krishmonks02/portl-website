...
class AWCDP_Deposits
{
  ...
  public function __construct() {
    ...
    function awcdp_register_post_types(){
      ...
      $plan_type = AWCDP_PLAN_TYPE;
      $labels = array(
          'name' => __('Payment plans', 'deposits-partial-payments-for-woocommerce'),
          'singular_name' => __('Payment plan', 'deposits-partial-payments-for-woocommerce'),
          'name_admin_bar' => 'AWWLM_Form',
          'add_new' => _x('Add New Payment plan', $plan_type, 'deposits-partial-payments-for-woocommerce'),
          'add_new_item' => sprintf(__('Add New %s', 'deposits-partial-payments-for-woocommerce'), 'Form'),
          'edit_item' => sprintf(__('Edit %s', 'deposits-partial-payments-for-woocommerce'), 'Form'),
          'new_item' => sprintf(__('New %s', 'deposits-partial-payments-for-woocommerce'), 'Form'),
          'all_items' => sprintf(__('Payment plans', 'deposits-partial-payments-for-woocommerce'), 'Form'),
          'view_item' => sprintf(__('View %s', 'deposits-partial-payments-for-woocommerce'), 'Form'),
          'search_items' => sprintf(__('Search %s', 'deposits-partial-payments-for-woocommerce'), 'Form'),
          'not_found' => sprintf(__('No %s Found', 'deposits-partial-payments-for-woocommerce'), 'Form'),
          'not_found_in_trash' => sprintf(__('No %s Found In Trash', 'deposits-partial-payments-for-woocommerce'), 'Form'),
          'parent_item_colon' => sprintf(__('Parent %s'), 'Form'),
          'menu_name' => 'Payment plans'
      );
      $args = array(
          'labels' => apply_filters($plan_type . '_labels', $labels),
          'description' => '',
          'public' => false,
      ...
      register_post_type($plan_type, apply_filters($plan_type . '_register_args', $args, $plan_type));
