...
if ( ! class_exists( 'AWCDP_Email_Payment_Reminder' ) ) {

	class AWCDP_Email_Payment_Reminder extends WC_Email {

		public function __construct() {
			$this->id          = 'awcdp_payment_reminder';
			$this->title       = __( 'Acowebs Payment Reminder', 'deposits-partial-payments-for-woocommerce' );
			$this->description = __( 'This emails will be sent to the customer as Reminder of partially paid order', 'deposits-partial-payments-for-woocommerce' );
      $this->customer_email = true;

			// $awwlm_es = get_option('woocommerce_awcdp_payment_reminder_settings');
			//
			...
			$this->template_html  = 'emails/customer-order-payment-reminder.php';
			$this->template_plain = 'emails/plain/customer-order-payment-reminder.php';

			// Triggers for this email.
			add_action('awcdp_deposits_partial_payment_reminder_email_notification', array($this, 'trigger'));
		...
		public function get_default_heading(){
			return esc_html__('Partial Payment Reminder #{order_number}', 'deposits-partial-payments-for-woocommerce');
		}

		public function get_default_subject(){
			return esc_html__('Your {site_title} order payment reminder {order_date}', 'deposits-partial-payments-for-woocommerce');
		}
    	...
    	return esc_html__("Please note that the partial payment for your order is still pending.", 'deposits-partial-payments-for-woocommerce');
    }
...
return new AWCDP_Email_Payment_Reminder();
